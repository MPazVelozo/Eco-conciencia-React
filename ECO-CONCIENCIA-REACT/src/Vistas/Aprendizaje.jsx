    ...
    <>
      <div className="main-containeruwu">
        ...
        <div className="Titulo-containeruwu">
          ...
          <h1 className="display-4" id="titulo">
            Actividades que enseñan y divierten
          </h1>
          <p>___________________________________________</p>
        </div>
        <div className="Reutilizar-container">
          ...
          <h1>___________</h1>
          <h3 className="reutilizar-letras">
            {" "}
            Reutilizar significa usar algo de nuevo en vez de desecharlo después
            de su primer uso, es decir, darle una segunda vida útil a un objeto,
            material o recurso, ya sea reparándolo, renovándolo o usándolo de
            manera diferente. Es una forma de reducir la cantidad de residuos
            que generamos.{" "}
          </h3>
          <div className="App">
            <CardWithImages
          ...
          <h3>
            {" "}
            Esta "R" del reciclaje está presente en todas las actividades que
            les vamos a presentar en esta sección:
          </h3>
        ...
        <div className="Papel-container">
          ...
          <div className="slider-containeruwu">
            <div className="leftArrowuwu" onClick={() => scrollToImage("prev")}>
              &#10092;
            </div>
            <div
              className="rightArrowuwu"
            ...
            <div className="dots-containeruwu">
              {data.map((_, idx) => (
                <div
                  key={idx}
                  className={`dot-container-itemuwu ${
                    idx === currentIndex ? "activeuwu" : ""
                  }`}
          ...
          <div className="Macetero-container2">
            ...
            <h3>
              Aprende a crear tu propio conejo macetero con botellas plásticas
            </h3>

            <div className="slider-container2uwu">
              <div
                className="leftArrow2uwu"
                onClick={() => scrollToImage2("prev2")}
              >
                &#10092;
              </div>
              <div
                className="rightArrow2uwu"
                onClick={() => scrollToImage2("next2")}
              >
                &#10093;
              </div>
              ...
              <div className="dots-container2uwu">
                {data2.map((_, idx) => (
                  <div
                    key={idx}
                    className={`dot-container-item2uwu ${
                      idx === currentIndex2 ? "active2uwu" : ""
                    }`}
